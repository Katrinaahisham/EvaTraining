...
export class ProductsComponent {
  ...
  constructor() {
    ...
    this.StoreLogo = "../assets/bread.jpg";
    this.ProductList = [
      { id: 1, name: "Product 1", quantity: 10, price: 20, img: "../assets/bread.jpg" },
      { id: 2, name: "Product 2", quantity: 5, price: 15, img: "../assets/bread.jpg" },
    ];
    this.CategoryList = [
